...
# Define models
random_forest_model = RandomForestClassifier(n_estimators=150, max_depth=7, min_samples_split=5,
...
catboost_model = catboost.CatBoostClassifier(learning_rate=0.1, max_depth=7, l2_leaf_reg=1, leaf_estimation_iterations=10, random_state=42, verbose=0)
xgb_model = xgb.XGBClassifier(learning_rate=0.1, max_depth=10, subsample=1, colsample_bylevel=0.25, gamma=0.2, random_state=42)
