...
grid_search = GridSearchCV(estimator=lgb_model, param_grid=param_grid, scoring='accuracy', cv=2, verbose=3)
...
# Train a new model with the best hyperparameters and get learning curves
best_model = lgb.LGBMClassifier(**grid_search.best_params_, verbose=-1, objective='multiclass',n_estimators=250)
