...
param_grid = {
    ...
    'l2_leaf_reg': [0, 0.001, 0.01],
    'iterations': [10, 50, 100, 150], # num_trees
...
random_search = RandomizedSearchCV(estimator=cbr_model, param_distributions=param_grid, n_iter=100, scoring='accuracy', cv=5, verbose=3, random_state=42)
...
best_model.fit(X_train_scaled, y_train, eval_set=(X_test_scaled, y_test), early_stopping_rounds=20)
