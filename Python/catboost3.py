...
# Plot the raw learning curves for each set of hyperparameters
plt.figure(figsize=(10, 6))
for i, params in enumerate(ParameterGrid(param_grid)):
    for fold in train_losses[i]:
        plt.plot(fold, label=f'Training Loss - {params}')

plt.title('Raw Training Loss Curves for Different Hyperparameter Combinations')
