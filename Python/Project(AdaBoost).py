...
train_data = abc(X_train, label=y_train)
...
lgb_model = abc(verbose=-1,num_classes=6, objective='multiclass')
...
best_model = abc(**grid_search.best_params_,verbose=-1, num_classes=6, objective='multiclass')
